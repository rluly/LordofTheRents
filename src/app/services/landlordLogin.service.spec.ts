...
import { LandlordLogin } from './landlordLogin.service';
...
describe('TenantLoginService', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(LandlordLogin);
  });
  ...
  it(`canActivate() should allow logged in Landlord to navigate to landlord pages`, () => {
  ...
  it(`canActivate() should NOT allow logged in Tenant to navigate to landlord pages`, () => {
    loginServiceSpy.getLogginUserInput.and.returnValue(
