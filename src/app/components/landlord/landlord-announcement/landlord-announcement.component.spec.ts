...
import { LandlordAnnouncementComponent } from './landlord-announcement.component';
...
describe('LandlordAnnouncementComponent', () => {
  let component: LandlordAnnouncementComponent;
  let fixture: ComponentFixture<LandlordAnnouncementComponent>;
  ...
  beforeEach(async () => {
    ...
    announcementServiceSpy.getLandlordAnnouncements.and.returnValue(
    ...
    fixture = TestBed.createComponent(LandlordAnnouncementComponent);
  ...
  it('should create an empty table if there is no logged in user', () => {
  ...
  it('getAnnouncemets should call getLandlordAnnouncements and store it in array', () => {
    ...
    expect(announcementServiceSpy.getLandlordAnnouncements).toHaveBeenCalled();
  });
